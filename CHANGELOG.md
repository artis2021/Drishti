...
- EPIC-10 frontend UI (US-10.01–10.04)
  - Next.js 14 app in `web/` with dark layout, repo indexing sidebar, SSE chat, Monaco editor
  - Clickable citations via `POST /api/v1/source/read`; `make dev-web` for local UI
